...
MUL_BF16_SPIRV        :: #load("shaders/mul_bf16.spv",        []u8)
MUL_BACK_A_BF16_SPIRV :: #load("shaders/mul_back_a_bf16.spv", []u8)
MUL_BACK_B_BF16_SPIRV :: #load("shaders/mul_back_b_bf16.spv", []u8)
...
GELU_BF16_SPIRV      :: #load("shaders/gelu_bf16.spv",      []u8)
GELU_BACK_BF16_SPIRV :: #load("shaders/gelu_back_bf16.spv", []u8)
GELU_LOCAL_SIZE :: 256
...
LAYERNORM_BF16_SPIRV             :: #load("shaders/layernorm_bf16.spv",             []u8)
LAYERNORM_STATS_BF16_SPIRV       :: #load("shaders/layernorm_stats_bf16.spv",       []u8)
LAYERNORM_BACK_INPUT_BF16_SPIRV  :: #load("shaders/layernorm_back_input_bf16.spv",  []u8)
LAYERNORM_BACK_WEIGHT_BF16_SPIRV :: #load("shaders/layernorm_back_weight_bf16.spv", []u8)
...
SOFTMAX_BACK_BF16_SPIRV :: #load("shaders/softmax_back_bf16.spv", []u8)
...
PERMUTE_BF16_SPIRV      :: #load("shaders/permute_bf16.spv",      []u8)
PERMUTE_BACK_BF16_SPIRV :: #load("shaders/permute_back_bf16.spv", []u8)
...
CAUSAL_MASK_BF16_SPIRV      :: #load("shaders/causal_mask_bf16.spv",      []u8)
CAUSAL_MASK_BACK_BF16_SPIRV :: #load("shaders/causal_mask_back_bf16.spv", []u8)
...
ATTENTION_BF16_SPIRV         :: #load("shaders/attention_bf16.spv",         []u8)
...
ROPE_BF16_SPIRV      :: #load("shaders/rope_bf16.spv",      []u8)
ROPE_BACK_BF16_SPIRV :: #load("shaders/rope_back_bf16.spv", []u8)
...
SLICE_TRAILING_BF16_SPIRV      :: #load("shaders/slice_trailing_bf16.spv",      []u8)
SLICE_TRAILING_BACK_BF16_SPIRV :: #load("shaders/slice_trailing_back_bf16.spv", []u8)
...
CONCAT3_BF16_SPIRV      :: #load("shaders/concat3_bf16.spv",      []u8)
CONCAT3_BACK_BF16_SPIRV :: #load("shaders/concat3_back_bf16.spv", []u8)
...
MEAN_BF16_SPIRV      :: #load("shaders/mean_bf16.spv",      []u8)
MEAN_BACK_BF16_SPIRV :: #load("shaders/mean_back_bf16.spv", []u8)
...
RELU_BF16_SPIRV         :: #load("shaders/relu_bf16.spv",         []u8)
RELU_BACK_BF16_SPIRV    :: #load("shaders/relu_back_bf16.spv",    []u8)
SIGMOID_BF16_SPIRV      :: #load("shaders/sigmoid_bf16.spv",      []u8)
SIGMOID_BACK_BF16_SPIRV :: #load("shaders/sigmoid_back_bf16.spv", []u8)
SILU_BF16_SPIRV         :: #load("shaders/silu_bf16.spv",         []u8)
SILU_BACK_BF16_SPIRV    :: #load("shaders/silu_back_bf16.spv",    []u8)
TANH_BF16_SPIRV         :: #load("shaders/tanh_bf16.spv",         []u8)
TANH_BACK_BF16_SPIRV    :: #load("shaders/tanh_back_bf16.spv",    []u8)
EXP_BF16_SPIRV          :: #load("shaders/exp_bf16.spv",          []u8)
EXP_BACK_BF16_SPIRV     :: #load("shaders/exp_back_bf16.spv",     []u8)
...
SUB_BF16_SPIRV        :: #load("shaders/sub_bf16.spv",        []u8)
SUB_BACK_A_BF16_SPIRV :: #load("shaders/sub_back_a_bf16.spv", []u8)
SUB_BACK_B_BF16_SPIRV :: #load("shaders/sub_back_b_bf16.spv", []u8)
...
DIV_BF16_SPIRV        :: #load("shaders/div_bf16.spv",        []u8)
DIV_BACK_A_BF16_SPIRV :: #load("shaders/div_back_a_bf16.spv", []u8)
DIV_BACK_B_BF16_SPIRV :: #load("shaders/div_back_b_bf16.spv", []u8)
...
SLICE_BF16_SPIRV      :: #load("shaders/slice_bf16.spv",      []u8)
SLICE_BACK_BF16_SPIRV :: #load("shaders/slice_back_bf16.spv", []u8)
...
LOG_SOFTMAX_BF16_SPIRV      :: #load("shaders/log_softmax_bf16.spv",      []u8)
LOG_SOFTMAX_BACK_BF16_SPIRV :: #load("shaders/log_softmax_back_bf16.spv", []u8)
...
ENTROPY_BF16_SPIRV      :: #load("shaders/entropy_bf16.spv",      []u8)
ENTROPY_BACK_BF16_SPIRV :: #load("shaders/entropy_back_bf16.spv", []u8)
